...
bool UAuraAbilitySystemLibrary::EnableFriendlyDamage(const AActor* Actor)
{
	if (!Actor->Implements<UCombatInterface>()) return false;
	
	return ICombatInterface::Execute_EnableFriendlyDamage(Actor);
}
